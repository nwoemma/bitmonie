export default function WithdrawNaira() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/20 to-secondary pt-32 pb-20 px-6">
      <div className="max-w-2xl mx-auto">
        <a href="/help-center" className="text-primary text-sm font-semibold hover:underline mb-6 block">← Back to Help Center</a>
        <h1 className="text-3xl font-black text-text-color mb-4" style={{ letterSpacing: '-0.5px' }}>
          How to Withdraw Naira to Your Bank Account
        </h1>
        ...
        <div className="bg-secondary/50 border border-primary/20 rounded-2xl p-8 text-text-color/80 leading-relaxed space-y-4">
          <p>Content coming soon. This article will walk you through how to withdraw Naira from your Bitmonie wallet directly to your Nigerian bank account.</p>
        </div>
      </div>
    </div>
  );
